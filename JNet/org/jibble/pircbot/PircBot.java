...
public abstract class PircBot implements ReplyConstants {
     ...
     */
    public static final String VERSION = "1.5.0 (Modified for JNet)";
    ...
    /**
     * Sets the master of the currently available botnet.
     * Only available to KingBot
     * @param nick - The nick to make BotMaster
     */
    
    public final void addBotMaster(String nick)
    {
    	if (this.getNick() == "KingBot")
    	{
