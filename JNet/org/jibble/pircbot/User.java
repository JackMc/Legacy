...
public class User {
     ...
     * hop. If the User object has been obtained from a list of users
     * in a channel, then this will reflect the user's hop status in
     * that channel.
     * 
     * @return true if the user has hop in the channel.
     */
     ...
     * in a channel, then this will reflect the user's Owner status in
     * that channel.
     * 
     * @return true if the user has owner in the channel.
     */
	public boolean isOwner() {
	    ...
	    /**
     * Returns whether or not the user represented by this object has
     * admin. If the User object has been obtained from a list of users
     * in a channel, then this will reflect the user's admin status in
     * that channel.
     * 
